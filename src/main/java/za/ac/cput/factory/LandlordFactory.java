...
public class LandlordFactory {
    public static Landlord buildLandlord(String firstName,String lastName, int numOfPropertiesOwned, String gender, LocalDate dateOfBirth, String password, Contact contact, List<Document> documents){
